Vue.component('tournamentlist', {
	...
	template: `
		<div class="list-group">
		    <div v-for="tournament in this.tournaments" class="list-group-item list-group-item-action">
    		    <div @click="open_page('https://soosanne.pythonanywhere.com/tournament/' + tournament.tournament_id)">
    		        <span class="lead font-weight-bold"><strong>{{ tournament.tournament_name }}</strong></span>
    		    </div>
		    </div>
		</div>
	`,
